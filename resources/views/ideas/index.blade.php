                            ...
                            @auth
                                <x-dropdown>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        @can('update',$idea)  <!--OBS. Si el usuario autenticado puede actualizar este idea, entonces va a aparecer el boton--->
                                            <x-dropdown-link :href="route('idea.edit',$idea)">
                                                Editar
                                            </x-dropdown-link>
                                        @endcan
                                        @can('delete',$idea) <!--OBS. Si el usuario autenticado puede eliminar este idea, entonces va a aparecer el boton--->
